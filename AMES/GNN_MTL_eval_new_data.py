...
def log_metrics(epoch, writer, y_internal, y_pred):
    ...
    metric_names = ["TP", "TN", "FP", "FN", "Specificity", "Sensitivity", "Precision", "Accuracy", "Balanced Accuracy",
                    "F1 Score", "H Score"]
...
def main():
    ...
    with torch.no_grad():
        for i, sample in enumerate(testLoader):
            ...
            y_pred_t = tuple(
                torch.where(tensor > thresholds[i], torch.tensor(1), torch.tensor(0)) for i, tensor in enumerate(pred))
    ...
    data_path = '/Users/abigailteitgen/Dropbox/Postdoc/AMES_GNN_MTL_Network/Additional_data/final_additional_dataset.csv'

    df = pd.read_csv(data_path)
    y_overall = df['Ames'].values
    ...
    headers = ['file', 'logits_98', 'logits_100', 'logits_102', 'logits_1535', 'logits_1537', 'y_true_98', 'y_true_100',
               'y_true_102', 'y_true_1535', 'y_true_1537', 'y_pred_98', 'y_pred_100', 'y_pred_102', 'y_pred_1535',
               'y_pred_1537', 'y_true_consensus', 'y_pred_consensus']
