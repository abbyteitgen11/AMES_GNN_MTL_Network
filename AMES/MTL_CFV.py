...
def run_MTL(x_train, x_test, y_train, y_test, lb, spec_lay, arq, w, fold):
    ...
    ckpt_name_cons = './ckpts_5fcv/5cepas/5_cepas'+ "_Params_" + str(params) + "_seed_" + str(seed) + "_fold_" + str(fold)+ '.weights.h5'
    ckpt_cons = ModelCheckpoint(ckpt_name_cons, monitor='val_loss', verbose=0, save_best_only=True, save_weights_only=True, mode='min')
    
    # train the modelclass BuildNN(nn.Module):
    #     def __init__(
    #         self,
    #         ni: int = 34,
    #         n0: int = 200,
    ...
    #     :param float ln: L2 regularization; default: None
    ...
    #     )
    #
    #     def zero_specific_layers(x):
    #         # STRAIN 1
    #         y1 = nn.Linear(x.size(1), 1)(x)  # Input size is x.size(1)
    #
    #         # STRAIN 2
    #         y2 = nn.Linear(x.size(1), 1)(x)
    #
    #         # STRAIN 3
    #         y3 = nn.Linear(x.size(1), 1)(x)
    #
    #         # STRAIN 4
    #         y4 = nn.Linear(x.size(1), 1)(x)
    #
    #         # STRAIN 5
    #         y5 = nn.Linear(x.size(1), 1)(x)
    #
    #         return y1, y2, y3, y4, y5
    #
    #     def one_specific_layers(x, n2):
    #         # STRAIN 1
    #         y1 = nn.Linear(x.size(1), n2)(x)  # Input size is x.size(1)
    #         y1 = nn.BatchNorm1d(n2, momentum=momentum_batch_norm)(y1)
    #         y1 = nn.Dropout(prob_h2)(y1)
    #
    #         # STRAIN 2
    #         y2 = nn.Linear(x.size(1), n2)(x)
    #         y2 = nn.BatchNorm1d(n2, momentum=momentum_batch_norm)(y2)
    #         y2 = nn.Dropout(prob_h2)(y2)
    #
    #         # STRAIN 3
    #         y3 = nn.Linear(x.size(1), n2)(x)
    #         y3 = nn.BatchNorm1d(n2, momentum=momentum_batch_norm)(y3)
    #         y3 = nn.Dropout(prob_h2)(y3)
    #
    #         # STRAIN 4
    #         y4 = nn.Linear(x.size(1), n2)(x)
    #         y4 = nn.BatchNorm1d(n2, momentum=momentum_batch_norm)(y4)
    #         y4 = nn.Dropout(prob_h2)(y4)
    #
    #         # STRAIN 5
    #         y5 = nn.Linear(x.size(1), n2)(x)
    #         y5 = nn.BatchNorm1d(n2, momentum=momentum_batch_norm)(y5)
    #         y5 = nn.Dropout(prob_h2)(y5)
    #
    #         return y1, y2, y3, y4, y5
    #
    #     def two_specific_layers(x, n2, n3):
    ...
    #         y1 = nn.BatchNorm1d(n2, momentum=momentum_batch_norm)(y1)
    #         y1 = nn.Dropout(prob_h2)(y1)
    #         y1 = nn.Linear(n2, n3)(y1)
    #         y1 = nn.BatchNorm1d(n3, momentum=momentum_batch_norm)(y1)
    #         y1 = nn.Dropout(prob_h3)(y1)
    #
    #         # STRAIN 2
    #         y2 = nn.Linear(x.size(1), n2)(x)
    #         y2 = nn.BatchNorm1d(n2, momentum=momentum_batch_norm)(y2)
    #         y2 = nn.Dropout(prob_h2)(y2)
    #         y2 = nn.Linear(n2, n3)(y2)
    #         y2 = nn.BatchNorm1d(n3, momentum=momentum_batch_norm)(y2)
    #         y2 = nn.Dropout(prob_h3)(y2)
    #
    #         # STRAIN 3
    #         y3 = nn.Linear(x.size(1), n2)(x)
    #         y3 = nn.BatchNorm1d(n2, momentum=momentum_batch_norm)(y3)
    #         y3 = nn.Dropout(prob_h2)(y3)
    #         y3 = nn.Linear(n2, n3)(y3)
    #         y3 = nn.BatchNorm1d(n3, momentum=momentum_batch_norm)(y3)
    #         y3 = nn.Dropout(prob_h3)(y3)
    #
    #         # STRAIN 4
    #         y4 = nn.Linear(x.size(1), n2)(x)
    #         y4 = nn.BatchNorm1d(n2, momentum=momentum_batch_norm)(y4)
    #         y4 = nn.Dropout(prob_h2)(y4)
    #         y4 = nn.Linear(n2, n3)(y4)
    #         y4 = nn.BatchNorm1d(n3, momentum=momentum_batch_norm)(y4)
    #         y4 = nn.Dropout(prob_h3)(y4)
    #
    #         # STRAIN 5
    #         y5 = nn.Linear(x.size(1), n2)(x)
    #         y5 = nn.BatchNorm1d(n2, momentum=momentum_batch_norm)(y5)
    #         y5 = nn.Dropout(prob_h2)(y5)
    #         y5 = nn.Linear(n2, n3)(y5)
    #         y5 = nn.BatchNorm1d(n3, momentum=momentum_batch_norm)(y5)
    #         y5 = nn.Dropout(prob_h3)(y5)
    #
    #         return y1, y2, y3, y4, y5
    #
    #     # Target-specific core
    #     if spec_layers == 0:
    #         self.target_layers = nn.ModuleList(zero_specific_layers())
    #     elif spec_layers == 1:
    #         self.target_layers = nn.ModuleList(one_specific_layers(n2))
    #     elif spec_layers == 2:
    #         self.target_layers = nn.ModuleList(two_specific_layers(n2, n3))
    #
    #
    #     def forward(self, x):
    #         # Shared core
    ...
    #
    #         # Target-specific core
    #         outputs = [layer(x) for layer in self.target_layers]
