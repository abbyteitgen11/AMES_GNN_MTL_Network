...
- train_sample.yml: input script for training model 
- graph_maker.py: main script for generating graphs (to run, specify .yml input file)
- GNN_MTL_GPU.py: main script for running GNN MTL model (to run, specify —input_file (.yml format) and —output_dir)
